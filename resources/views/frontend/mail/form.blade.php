...
<table align="center" border="0" cellpadding="0" cellspacing="0"
       style="padding: 0 30px;background-color: #fff; box-shadow: 0px 0px 14px -4px rgba(0, 0, 0, 0.2705882353);width: 500px; -webkit-box-shadow: 0px 0px 14px -4px rgba(0, 0, 0, 0.2705882353);">
    <tbody>
    <tr>
        <td>
            <table align="center" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td>
                        <h2 class="title">WEB SİTE FORM</h2>
                    </td>
                </tr>
                </tbody>
            </table>
            ...
            <table class="order-detail" style="margin-top: 10px;width: 100%;margin-bottom: 15px;" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td style="line-height: 49px;text-align: right;padding-right: 28px;font-size: 13px;color: #000000;text-align:right;border-left: unset;"
                        colspan="3" class="price"><b>{{ $request->name }}</b></td>
                </tr>
                ...
                <tr>
                    <td colspan="2" style="line-height: 49px;font-size: 13px;color: #000000;
                                    padding-left: 20px;text-align:left;border-right: unset;">Telefon :</td>
                    <td colspan="3" class="price"
                        style="
