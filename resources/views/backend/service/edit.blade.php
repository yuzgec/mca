...
@section('content')
    {{Form::model($Edit, ["route" => [$Edit->getTable().".service", $Edit->id],'enctype' => 'multipart/form-data'])}}
    @method('PUT')
    <div class="row">
        <div class="col-12 col-md-9">
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <div>
                        <a class="btn btn-tabler btn-sm p-2" href="{{ route('service', $Edit->slug) }}" title="Geri">
